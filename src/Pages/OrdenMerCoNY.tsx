...
const OrdenMerCoNY: React.FC<OrdenMerCoNYProps> = ({ onCompanySelect }) => {
  ...
  const handleConfirmar = async () => {
    ...
    try {
      ...
      if (!response.ok) throw new Error(`Error al crear orden: ${response.status}`);
