...
import styles from '../Style/comisionista.module.css';
...
const Comisionista = () => {
  ...
  return (
    <div className={styles.comisionistaContainer}>
      <form className={styles.comisionistaForm} onSubmit={handleSubmit}>
        ...
        <div className={styles.formGroup}>
          <label htmlFor="correo">CorreoC:</label>
          <InputText
            id="correo"
            value={correo}
      ...
      <Dialog 
        ...
        header="Verificación de Seguridad - Comisionista"
        footer={footer}
