/* funcional simple import React from 'react';
  ...
  return (
    <form className={styles.formulario}>
      <div className={styles.inputGroup}>
        <label className={styles.label}>NombreC:</label>
        <input className={styles.input} type="text" name="nombre" />
      </div>

      <div className={styles.inputGroup}>
        <label className={styles.label}>CorreoC:</label>
        <input className={styles.input} type="email" name="correo" />
      </div>

      <div className={styles.inputGroup}>
        <label className={styles.label}>ContraseñaC:</label>
